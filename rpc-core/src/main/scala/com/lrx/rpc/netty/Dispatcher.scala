...
import com.lrx.RpcException
import com.lrx.rpc.{RpcEndpoint, RpcEndpointAddress, RpcEndpointRef, RpcEnvStoppedException}
import com.lrx.util.ThreadUtils
...
private[netty] class Dispatcher(nettyEnv: NettyRpcEnv) {
  ...
  /**
    * Send a message to all registered [[com.lrx.rpc.RpcEndpoint]]s in this process.
    *
