...
import com.lrx.rpc.{RpcAddress, RpcEndpoint, ThreadSafeRpcEndpoint}
...
/**
  * An inbox that stores messages for an [[com.lrx.rpc.RpcEndpoint]] and posts messages to it thread-safely.
  */
