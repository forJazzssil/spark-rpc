...
package com.lrx.serializer
import java.io._
import java.nio.ByteBuffer

import com.lrx.RpcConf
import com.lrx.util.{ByteBufferInputStream, ByteBufferOutputStream, Utils}
...
class JavaSerializer(conf: RpcConf) extends Serializer with Externalizable {
  ...
  override def newInstance(): SerializerInstance = {
    ...
    val streamFactory: SerializationStreamFactory = classLoader
      .loadClass(conf.get("spark.rpc.serialization.stream.factory", "com.lrx.serializer.JavaSerializationStreamFactory"))
